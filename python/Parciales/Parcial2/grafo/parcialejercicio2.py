...
grafosw.insert_arist(Arista('Luke Skywalker',20), 'Yoda', 'Luke Skywalker', criterio_arista='vertice')
grafosw.insert_arist(Arista('R2-D2',12), 'Boba Fett', 'R2-D2', criterio_arista='vertice')
grafosw.insert_arist(Arista('R2-D2',12), 'Luke Skywalker', 'R2-D2', criterio_arista='vertice')
grafosw.insert_arist(Arista('Leia',10), 'Yoda', 'Leia', criterio_arista='vertice')
grafosw.insert_arist(Arista('R2-D2',14), 'Leia', 'R2-D2', criterio_arista='vertice')
